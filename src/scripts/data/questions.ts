// Curated relationship-themed easy questions parsed from the MVP source document.
// These are seeded into BOTH Level 1 and Level 2 (admin can differentiate later).
...
export const QUESTIONS: SeedQuestion[] = [
  ...
  { text: "What is a caring way to respond when your partner seems quiet?", options: { A: 'Ask gently how they are feeling', B: "Ask quickly what's wrong", C: 'Ignore them', D: 'Change the topic' }, correctOption: 'A' },
  ...
  { text: 'What defines emotional closeness?', options: { A: 'Feeling understood', B: 'Feeling accepted', C: 'Feeling connected', D: 'Feeling safe' }, correctOption: 'C' },
  { text: 'When love continues to feel intentional over time, what sustains it?', options: { A: 'Effort', B: 'Awareness', C: 'Choice', D: 'Connection' }, correctOption: 'C' },
  { text: 'If both partners adapt without resentment, what is being maintained?', options: { A: 'Respect', B: 'Balance', C: 'Harmony', D: 'Understanding' }, correctOption: 'B' },
];
